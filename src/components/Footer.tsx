    ...
    <footer className="bg-dark border-t border-white/5 pt-16 pb-12 px-6 lg:px-12 text-left relative z-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 pb-12 border-b border-white/5">
        ...
        <div className="md:col-span-3 space-y-3.5 text-left">
          ...
          <AnimatePresence>
            {isSubscribed && (
              <motion.p
                className="text-[10px] font-mono text-gold-400 uppercase mt-2"
      ...
      <div className="max-w-7xl mx-auto pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-white/65 space-y-4 md:space-y-0">
        ...
        <button
          ...
          className="p-2.5 border border-white/10 rounded-full hover:border-gold-400/50 text-white/60 hover:text-gold-300 transition-all flex items-center justify-center cursor-pointer group"
          title="Back to Top"
        >
